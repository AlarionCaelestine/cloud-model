...
# ╔═╡ cc0ca5ef-b0d6-425f-8ea9-285287030a5a
begin
	using Unitful, UnitfulAstro, GLMakie, LinearAlgebra, StaticArrays, ProgressLogging 
	using Base.Threads: @threads, nthreads, threadid
end

# ╔═╡ ab5a213a-1df6-11f0-1ce9-53ed4a99a7ce
md"""
...
# ╔═╡ 8e2f2fb0-467c-43bd-923e-c885987be400
md"""
### Фундаментальные константы
"""

# ╔═╡ be88e8bb-6433-4b9d-84ec-e73ec7fbe6d4
begin
...
# ╔═╡ 7a8d769a-b302-4ef6-96c8-215716340ae0
md"""
### Инициализация констант
"""

# ╔═╡ ee6e5249-d94f-4ae2-a136-128bc07808d6
md"""
### Инициализация начального состояния
"""

# ╔═╡ 31673472-2e3a-436c-956c-21dd9e1deb90
md"""
### Итерации
"""
...
# ╔═╡ b98a7137-4857-4e64-9652-432b6c6ebc4b
...
mutable struct SimulationState
	...
	iterations_done::Int64  # Итерациий проведено
end
...
# ╔═╡ aa53234d-287e-45e8-96b5-27d3180b5150
state = initialize_simulation_state(
        ustrip(Float64, u"m", size),  # Размер области в метрах
        constants
    );
...
# ╔═╡ 496078a1-af9e-4a6a-a3b4-f32ca97373ba
begin
...
manifest_format = "2.0"
project_hash = "55b4cb61e894df3e6e5be3cbf19cc2d6f0dbc982"
...
git-tree-sha1 = "7279fc8e4686883a3e773e1c00693d1ae0e8476c"
